...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/figure5_component_map.png}
  \caption{Component map --- pipeline boxes with arrows from data preparation through prediction, optimization, and explanation.}
\end{figure}
